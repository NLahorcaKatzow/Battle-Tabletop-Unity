        ...
        private static void OnHierarchyWindow(int instanceID, Rect selectionRect)
        {
            ...
            if (instance != null)
            {
                for (int i = 0; i < colorPalette.colorDesigns.Count; i++)
                {
                    ...
                    colors[0] = new GradientColorKey(design.backgroundColor, 0.0f);
                    colors[1] = new GradientColorKey(design.backgroundColor, 1.0f);
                    ...
                    if (instance.name.StartsWith(design.keyChar))
                    {
                        ...
                        EditorGUI.DrawRect(selectionRect, gradient.Evaluate(0));
